...
HD_PWD='E:/Digital Systems/Week 2/nbit_parallel_inserial_out/nbit_parallel_inserial_out.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_sh_both_ends_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reg_sh_both_ends_tb.tcl -notrace
