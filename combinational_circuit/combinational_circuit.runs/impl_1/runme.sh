...
HD_PWD='E:/Digital Systems/Week 2/combinational_circuit/combinational_circuit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log weight_cmp_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source weight_cmp_tb.tcl -notrace
