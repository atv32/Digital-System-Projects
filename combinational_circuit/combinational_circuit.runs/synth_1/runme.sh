...
HD_PWD='E:/Digital Systems/Week 2/combinational_circuit/combinational_circuit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weight_cmp_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weight_cmp_tb.tcl
